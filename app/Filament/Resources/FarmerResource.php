...
class FarmerResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Farmers & Company Information';
    protected static ?string $label = 'Farmers';
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('icno')
                    ->required()
                    ->maxLength(255),
            ]);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->searchable(),
                Tables\Columns\TextColumn::make('icno')
                    ->searchable(),
